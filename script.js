...
const answers = Array.from(document.querySelectorAll(".answer")) //querySelectorAll returs not an array but collection, so we need to convert it into array: Array.from()
